...
export interface StockCell5Props {
  img: string;
  name: string;
  price: string;
  flag: string;
...
const StockCell5 = React.memo(function StockCell5({
  img,
  name,
  price,
  flag,
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-[90px] leading-[100%] ml-[80px] min-w-[200px] font-wooridaumR"
          style={{ contain: "layout style" }}
        >
          {name}
        </div>
        ...
        <div
          className="text-[110px] leading-[100%] ml-[80px] min-w-[150px] font-wooridaumR"
          style={{ contain: "layout style" }}
        >
          {formattedPrice}
        </div>
      ...
      <div className="flex flex-row flex-nowrap ml-[80px] mr-[100px]">
      ...
      <div className="h-[120px] min-w-[4px] bg-[#ffffff30]"></div>
    </div>
  );
});

export default StockCell5;
